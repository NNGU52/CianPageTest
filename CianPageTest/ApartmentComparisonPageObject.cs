...
namespace CianPageTest
{
    class ApartmentComparisonPageObject
    {
        ...
        private readonly By _addApartmentOneApatmentButton = By.XPath("(//button[@data-mark='ComparisonControl'])[1]");
        private readonly By _addApartmentTwoApartmentButton = By.XPath("(//button[@data-mark='ComparisonControl'])[2]");
        ...
        public void ClickAddApartment()
        {
            ...
            var addApartmentOneApatment = driver.FindElement(_addApartmentOneApatmentButton);
            ...
            var addApartmentTwoApartment = driver.FindElement(_addApartmentTwoApartmentButton);
